...
class AppColors {
  ...
  // --- GRADYANLAR ---
  static const List<Color> runningGradient = [Color(0xFF1A2980), Color(0xFF26D0CE)];
  ...
  static const List<Color> finishedGradient = [Color(0xFF093028), Color(0xFF237A57)];

  // ============================================================
  // MANTIK MERKEZİ
  // ============================================================

  static List<Color> getBackgroundGradient(bool isRunning, bool isPaused, bool isAlarm, Color defaultColor) {
  ...
  static Color getRingColor(bool isRunning, bool isPaused, bool isAlarm, Color defaultColor) {
  ...
  // 3. Sayaç Yazı Rengi
  static Color getTimerTextColor(bool isRunning, bool isPaused, bool isAlarm, Color defaultColor) {
  ...
  static Color getMainButtonBackgroundColor(bool isRunning, bool isPaused, bool isAlarm, Color defaultColor) {
    if (isAlarm || isPaused || isRunning) return white;
    return defaultColor;
  }

  // 5. Ana Buton İçerik Rengi
  static Color getMainButtonContentColor(bool isRunning, bool isPaused, bool isAlarm) {
  ...
  static Color? getTopButtonActiveColor(bool isRunning, bool isPaused, bool isAlarm) {
  ...
  // 7. Sıfırla Yazısı
  static Color getResetTextColor(bool isActive, bool isPaused, Color defaultColor) {
